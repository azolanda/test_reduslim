    ...
    $.widget('custom.phonecode', {
        ...
        _initSelector: function() {
            ...
            for(var i = 0; i < this.data.length; i++) {
                ...
                //     ' class="country-phone-option"><span>+'+ country.ph +'<img src="plugin_country_flags/blank.gif" class="flag flag-'+
                //     country.co +
                //     '"></span>' + country.na +'</div>'
                // );
                var option = $('<div data-phone="'+
                country.ph + '" data-co="'+ prefCountry.toLowerCase() +'"' +
                    ' class="country-phone-option"><span>'+country.co.toUpperCase()+'<img src="plugin_country_flags/blank.gif" class="flag flag-'+
                    country.co +
                    '" style="margin-left: 10px;"></span>' + country.na +'</div>'
                );
            ...
            if(selected) {
                this.container.find('.country-phone-selected')
                    .html(selected.co.toUpperCase() + '<img src="plugin_country_flags/blank.gif" class="flag flag-'+ selected.co +'"><img src="plugin_country_flags/arrow-down.svg" style="margin-bottom: 3px;">' );
            }
        ...
        setElementSelected: function(el) {
            ...
            var sel = $(el).html();
            sel = sel.split('</span>');
            $(selector).html(sel[0] +'</span><img src="plugin_country_flags/arrow-down.svg" style="margin-bottom: 3px;">');
